        ...
        <table class="table table-striped custab">
            ...
            @foreach($alldata as $data)
                <tr>
                    ...
                    <td>{{$data->issue_id}}</td>
                    <td class="text-center"><a class='btn btn-info btn-xs' href="{{Route('BARD_modules.edit',$data->id)}}"><span class="glyphicon glyphicon-edit"></span> Edit</a>
                        {!! Form::open(array('route'=>['BARD_modules.destroy',$data->id],'class'=>'form-horizental','method'=>'delete')) !!}
